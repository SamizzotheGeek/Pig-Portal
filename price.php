...
$flag=0;
$temp=0;
$pig=$_POST['pigs']; //pig name;
$quantity=$_POST['trade_farmer_pigquantity']; //quantity
...
$query2="SELECT pig_quantity from farmer_pigs_trade where Trade_pig='$pig'";
$result2 = mysqli_query($conn, $query2);
while($row2 = $result2->fetch_assoc()) {
	$temp+=$row2["pig_quantity"];
}
                ...
                <table class="table table-striped table-bordered table-responsive-md btn-table">
                    ...
                    <tr>
                        ...
                        <form method="POST" action="price.php?action=add&id=<?php echo $TradeId ?>">
                            <input name="hidden_name" value="<?php echo $pig ?>">
