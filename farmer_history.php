...
$sql = "SELECT farmer_pig, farmer_quantity, farmer_price, `date` FROM farmer_history WHERE farmer_id='".$farmer_id."' ";
...
<tr>
    ...
    <th><center>Pigs</center></th>
    <th><center>Quantity </center></th>
    <th><center>Total Amount received (in $)</center></th>
...
while($row = $result->fetch_assoc()) {
    $pigname=ucfirst($row["farmer_pig"]);
    $pigquantity=$row["farmer_quantity"];
    $pigprice=$row["farmer_price"];
    $currentdate=$row['date'];

echo "<tr>";
    echo "<td><center>$pigname</center></td>";
    echo "<td><center>$pigquantity</center></td>";
    echo "<td><center>$pigprice</center></td>";
